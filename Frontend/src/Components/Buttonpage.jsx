        ...
        <div className="twopage">
            <div>
                ...
                <div className="box5">
                    ...
                    <p style={{fontSize:"17px",color:"black"}}><b>Confirmation email</b></p>
                    <p>Please enter the email address where you would like to receive your confirmation.</p>
                    <div className="inputdiv">
                        <p className="name">Email adress</p>
                        <input type="email" placeholder="(e.g. xyz@gmail.com)" className="input" style={{width:"55%"}}/>
                    </div>
                    <hr style={{borderTop:"1px solid #616161",marginTop:"20px"}}/>
                    <p style={{fontSize:"17px",color:"black",marginTop:"10px"}}><b>Create an account</b></p>
                    <p style={{color:"green",display:"flex",marginTop:"7px",alignItems:"center"}}><TbChevronRight/>  Earn points for free travel <TbChevronRight/> Save with Member Prices <TbChevronRight/> Easily access your itineraries</p>
                    <p style={{marginButtom:"10px"}}>Enter a password to create an account using the email address above.</p>
                    <div className="inputdiv">
                        <p className="name">Create an password</p>
                        <input type="password" placeholder="6 - 30 characters, no spaces" className="input" style={{width:"35%"}}/>
                    </div>
                    <div className="inputdiv">
                        <p className="name">Confirm password</p>
                        <input type="password" className="input" style={{width:"35%"}}/>
                    </div>
                    <p style={{marginTop:"11px"}}>By creating an account, I agree to the<a style={{color:"#4d4dd8"}} href="https://www.expedia.com/lp/lg-legal"> Terms of Use,</a><a style={{color:"#4d4dd8"}} href="https://www.expedia.com/lp/lg-privacypolicy"> Privacy Policy</a> <a style={{color:"#4d4dd8"}} href="https://www.expedia.com/lp/b/exp-rewards-terms">, and Expedia Rewards Terms and Conditions.</a> </p>
                </div>

                {/* Important Information  */}

                <div className="box6">
                    <p style={{fontSize:"17px",color:"black",marginTop:"10px",marginBottom:"10px"}}><b>Important information about your booking</b></p>
                    <div className="overflow">
                            <li>Cancellations or changes made after 11:59pm (property local time) on Sep 1, 2022 or no-shows are subject to a property fee equal to 100% of the total amount paid for the reservation.</li>
                            <li>The host will greet guests on arrival. For more details, please contact the property using the information on the booking confirmation.</li>
                            ...
                            <p>1. Christmas Eve (24 December) Gala Dinner per adult: INR 4500.00</p> 
                            <p>2. Christmas Eve (24 December) Gala Dinner per child: INR 2250.00 (from 6 to 12 years old)</p> 
                            <p>3. New Year's Eve (31 December) Gala Dinner per adult: INR 8500.00</p> 
                            <p>4. New Year's Eve (31 December) Gala Dinner per child: INR 4250.00 (from 6 to 12 years old)</p>   
                    </div>
            ...
            <div>
                ...
                <div className="box8">
                    <h3 style={{fontSize:"20px",fontWeight:"bold"}}>Price details</h3>
                    ...
                    <p style={{marginBottom:"20px"}}>Mandatory charge: Collected at property.</p>
                    <p style={{fontSize:".7em"}}>Taxes and Fees due at the property are based on current exchange rates, and are payable in local currency.</p>
                </div>
            </div>
        </div>
    </div>
