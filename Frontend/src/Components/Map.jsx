...
const Map = ({width="240px",height="220px"}) => {
 ...
 useEffect(()=>{
  ...
  return (
    <div className="w-fit pb-4 m-auto  text-center bg-white border-1 border-solid border-black  rounded-2xl" >
        <iframe style={{borderRadius:"10px"}}  width={width} height={height} src={`https://maps.google.com/maps?q=${_city || "pune"}&t=&z=11&ie=UTF8&iwloc=&output=embed`} scrolling="no"></iframe>
        <Link to="">
