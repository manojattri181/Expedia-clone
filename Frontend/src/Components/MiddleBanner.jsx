            ...
            <SimpleGrid spacing={6} mt='1rem' columns={{ sm: '1', md: '2', lg: '3' }}>
                ...
                <Box cursor='pointer'>
                    ...
                    <Box mt='0.5rem'>
                        ...
                        <Text fontSize='1.1rem' fontWeight='500'>Plan a city getaway with member-only deals on select hotels</Text>
                    </Box>
                </Box>
                ...
                <Box cursor='pointer'>
                    ...
                    <Box mt='0.5rem'>
                        ...
                        <Text fontSize='1.1rem' fontWeight='500'>Members can double dip with points on top of airline miles</Text>
                    </Box>
                </Box>
                ...
                <Box cursor='pointer'>
                    ...
                    <Box mt='0.5rem'>
                        ...
                        <Text fontSize='1.1rem' fontWeight='500'>Save on these last-minute weekend getaways.</Text>
                    </Box>
                </Box>
            ...
            <SimpleGrid mt='25px' spacing={7} columns={{ sm: '1', md: '2' }}>
                ...
                <Box cursor='pointer'>
                    ...
                    <Box mt='0.5rem'>
                        ...
                        <Text fontSize='1.1rem' fontWeight='500'>There's a whole lot of world out there—go see more of it</Text>
                    </Box>
                </Box>
                ...
                <Box cursor='pointer'>
                    ...
                    <Box mt='0.5rem'>
                        ...
                        <Text fontSize='1.1rem' fontWeight='500'>Experience ultimate relaxation with a coastal getaway</Text>
                    </Box>
                </Box>
            </SimpleGrid>
